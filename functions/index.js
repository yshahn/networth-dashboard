...
const COINBASE_API_SECRET = defineSecret("COINBASE_API_SECRET");
...
/**
 * 7) Coinbase direct API integration — fetches all wallet balances
 *    for the connected Coinbase account without going through Plaid.
 *    Uses Coinbase Advanced Trade API v3 with HMAC-SHA256 signing.
 */
exports.getCoinbaseBalances = onCall(
